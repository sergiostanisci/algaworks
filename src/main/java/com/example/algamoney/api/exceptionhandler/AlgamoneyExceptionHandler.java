...
public class AlgamoneyExceptionHandler extends ResponseEntityExceptionHandler {
	...
	protected ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex,
		...
		String mensagemDesenvolvedor = ex != null && ex.getCause() != null ? ex.getCause().toString()
				: ex.toString();
	...
	public ResponseEntity<Object> handleDataIn(DataIntegrityViolationException ex, WebRequest request){
