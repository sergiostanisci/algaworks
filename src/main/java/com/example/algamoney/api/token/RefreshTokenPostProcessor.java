...
public class RefreshTokenPostProcessor implements ResponseBodyAdvice<OAuth2AccessToken> {
	...
	// vai interceptar quando for um response body e o nome do metodo for o postAcessToken
	@Override
	...
	private void adicionaRefreshTokenNoCookie(String refreshToken, HttpServletRequest req, HttpServletResponse resp) {
		...
		refreshTokenCookie.setSecure(algamoneyApiProperty.getSeguranca().isEnableHttps()); // TODO: em producao sera true
